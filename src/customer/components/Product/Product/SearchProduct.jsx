...
import { Backdrop, CircularProgress, FormControl, FormControlLabel, FormLabel, Pagination, Radio, RadioGroup } from '@mui/material'
import FilterAltIcon from '@mui/icons-material/FilterAlt';
import { useLocation, useNavigate, useParams } from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import {findProductsByQuery } from '../../../../State/customer/Product/Action.js'
// const sortOptions = [
...
export default function searchProduct() {
    ...
    useEffect(() => {
        ...
        dispatch(findProductsByQuery(data));
    }, [
        param.lavelThree,
        colorValue,
        sizeValue,
    ...
    return (
        <div className="bg-white">
            <div>
                ...
                <Dialog open={mobileFiltersOpen} onClose={setMobileFiltersOpen} className="relative z-60 lg:hidden">
                    <DialogBackdrop
                        transition
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            <form className="hidden lg:block">
                                <div className='py-10 flex justify-between'>
                                    ...
                                    <FilterAltIcon className='text-black opacity-50' />
                                </div>
                                {filters.map((section) => (
                                ...
                                {singleFilter.map((section) => (
                                    <Disclosure key={section.id} as="div" className="border-t border-gray-200 px-4 py-6">
                                        <h3 className="-mx-6 -my-3 flow-root">
                                            <DisclosureButton className="group flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500">
                                                <FormLabel id="demo-radio-buttons-group-label" sx={{ color: 'black' }}>{section.name}</FormLabel>
                                                <span className="ml-6 flex items-center">
                                                    <PlusIcon aria-hidden="true" className="size-5 group-data-open:hidden" />
