...
import { createPayment } from '../../../State/customer/Payment/Action';
...
const OrderSummary = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="lg:grid grid-cols-3 relative justify-between pb-4">
        ...
        <div className="sticky top-20 h-[100vh] mt-5 lg:mt-0 ml-5">
